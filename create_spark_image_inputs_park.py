...
if __name__ == "__main__":
    ...
    dir_path = '/gpfs/gpfsfpo/Park/*.jpg'
    ...
    for fn in glob.glob(path):
        try:
            ...
            writeOutput('/gpfs/gpfsfpo/shared/park_raw.txt', raw_img)
            writeOutput('/gpfs/gpfsfpo/shared/park_gs.txt', gs_img)
            writeOutput('/gpfs/gpfsfpo/shared/park_raw_blur.txt', raw_blur)
            writeOutput('/gpfs/gpfsfpo/shared/park_gs_blur.txt', gs_blur)
